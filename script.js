...
const questions = [
  {
    id: 1,
    text: "Выберите нужный знак: \\( >, < \\) или \\(=  \\) : \\( 203 \\)___ \\(230\\)",
    type: "options",
    options: ["\\(>\\)", "\\(<\\)", "\\(=\\)"],
    style: "width: 150px",
    correct: "\\(<\\)",
  ...
  {
    id: 2,
    text: "Вычислите: \\( 327 + 158 = \\) </br> </br> Напишите ответ ниже",
    style: "width: 500px",
    type: "short",
    correct: "485",
  },
  {
    id: 3,
    text: "Вычислите: \\( 480 – 265 = \\) </br> </br> Напишите ответ ниже",
    type: "short",
    correct: "215",
  },
  {
    id: 4,
    text: "Вычислите: \\( 130 × 40 = \\) </br> </br> Напишите ответ ниже",
    type: "short",
    correct: "5200",
  },
  {
    id: 5,
    text: "Найдите значение выражения: \\( 9600:(6+2) = \\) </br> </br> Напишите ответ ниже",
    type: "short",
    correct: "1200",
  },
  {
    id: 6,
    text: "Найдите значение выражения: \\( 10404:17 = \\) </br> </br> Напишите ответ ниже",
    type: "short",
    correct: "612",
  },
  {
    id: 7,
    text: "Найдите закономерность и продолжите ряд: \\( 2, 4, 8, 16, \\) ___ </br> </br> Напишите ответ ниже",
    type: "short",
    correct: "5",
  },
  {
    id: 8,
    text: "Решите задачу и запишите ответ ниже: </br> </br> У Маши было 36 конфет. Она отдала Вите 2 штуки, а Лене — в 3 раза больше, чем Вите. Сколько конфет у Маши осталось?",
    type: "short",
    correct: "28",
  },
  {
    id: 9,
    text: "Переведите в метры и запишите ответ ниже: 3 км = ___ м",
    type: "short",
    correct: "3000",
  },
  {
    id: 10,
    text: "Выразите в сантиметрах и запишите ответ ниже: 2 м 4 см = ___ см  ",
    type: "short",
    correct: "204",
  },
  {
    id: 11,
    text: "Сколько минут в 2 часах 30 минутах? </br> Запишите ответ ниже",
    type: "short",
    correct: "150",
  },
  {
    id: 12,
    text: "Какая фигура имеет всего 3 стороны?",
    type: "options",
    options: ["Квадрат", "Прямоугольник", "Круг", "Треугольник"],
    correct: "Треугольник",
  },

  {
    id: 13,
    text: "Назовите фигуру, у которой все стороны и углы равны",
    type: "options",
    options: ["Квадрат", "Прямоугольник", "Круг", "Треугольник"],
    correct: "Квадрат",
  },
  ...
  {
    id: 14,
    text: "Периметр квадрата 24, найдите его площадь",
    type: "short",
    correct: "36",
  },
  {
    id: 15,
    text: "Найдите периметр прямоугольника со сторонами 6 см и 4 см и запишите ответ ниже",
    type: "short",
    correct: "20",
  },
  {
    id: 16,
    text: "Найдите остаток при делении \\( 29 : 5 \\) и запишите его ниже",
    type: "short",
    correct: "4",
  },
  {
    id: 17,
    text: "Какое из чисел кратно 5?  ",
    type: "options",
    options: ["23", "51", "108", "30"],
    correct: "30",
  },
  {
    id: 18,
    ...
    type: "options",
    options: [
      "Все квадратные фигуры - прямоугольники",
      "Все прямоугольники - квадраты",
      "Все прямоугольники - квадраты",
      "У треугольника всегда 4 стороны",
    ],
    correct: "Все квадратные фигуры - прямоугольники",
  },
  {
    id: 19,
    text: "Масса восьми банок с вареньем составляет 12 кг. Определите массу варенья в одной банке, если масса пустой банки — 300 г. </br> </br> Выразите ответ в граммах и запишите ответ ниже",
    type: "short",
    correct: "1200",
  },
  {
    id: 20,
    text: "До остановки автобус проехал 150 км за 2 часа, затем он увеличил скорость на 15 км/ч и проехал 3 часа. Какое общее расстояние в километрах проехал автобус?",
    type: "short",
    correct: "420",
  },
];

const STORAGE_KEY = "diagnostic5";
...
async function sendEmail() {
  ...
  const subject = `Диагностика 8 кл — ${data.studentName}`;
